...
export default {
  ...
  created() {
    this.chartOptions = this.formatChartOptions(this.$route.params.symbol);
    
    this.loadCoin(this.$route.params.symbol).then(response => {
      this.coinData = response.data;
    })
  },

  mounted() {
      this.loadChart(this.$route.params.symbol);
  },
